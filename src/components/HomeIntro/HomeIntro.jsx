...
const HomeIntro = () => {
  ...
  return (
    <div className="w-full h-full flex bg-gradient-to-r from-blue-dark to-blue-mid justify-center items-center overflow-hidden">
      {!isPhoneScreen && (
        <div className="absolute inset-0 flex justify-center pointer-events-none z-0 overflow-hidden">
          <div className="relative max-w-[1440px] w-full h-full">
      ...
      <div className="w-full h-full flex flex-col items-center justify-center overflow-hidden z-[1]">
        <div className="border-b-[30px] border-blue-light flex w-full items-center justify-center overflow-hidden">
          <div className="flex justify-center pb-10 w-full">
            ...
            <div className="relative flex items-center md:pt-20 pt-[7.5rem] w-[75rem]">
              {/* TITLE */}
              <LargeTitle />
              ...
              <img
                ...
                className={`object-cover z-[1] transition-opacity duration-[2000ms] ease-out ${
                  visible ? "opacity-100" : "opacity-0"
                } ${
                  isPhoneScreen
                    ? "absolute w-[18rem] h-[18rem] right-0 bottom-[-40px]"
                    : "absolute right-0 bottom-[-40px] w-[30rem] h-[30rem]"
                }`}
              />
            </div>
          </div>
